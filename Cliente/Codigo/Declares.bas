...
Public Declare Function GetTickCount Lib "kernel32" () As Long 'ANTICHEAT
Public Uclickear As Boolean
Public PuedeUclickear As Boolean
Public Fide As Byte
Public Sincroniza As Single 'ANTICHEAT
...
Public HayMapa As Integer 'MAPA
Public DMapa As Integer 'MAPA
Public Rmapa As RECT 'MAPA
Public HayCuenta As Integer 'CUENTA
Public DCuenta As Integer 'CUENTA
Public RCuenta As RECT 'CUENTA
Public HayCuenta3 As Integer 'CUENTA
Public DCuenta3 As Integer 'CUENTA
Public RCuenta3 As RECT 'CUENTA
Public HayCuenta2 As Integer 'CUENTA
Public DCuenta2 As Integer 'CUENTA
Public RCuenta2 As RECT 'CUENTA
Public HayCuenta1 As Integer 'CUENTA
Public DCuenta1 As Integer 'CUENTA
Public RCuenta1 As RECT 'CUENTA
