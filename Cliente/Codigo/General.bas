...
Call AddtoRichTextBox(frmMain.rectxt, UserName & " bienvenido a Gathering AO v2.0 (BETA)", 255, 150, 50, 1, 0)
Call AddtoRichTextBox(frmMain.rectxt, "Al jugar nuestro servidor estás aceptando todos los términos de nuestro reglamento, publicado en www.Gathering-AO.com.ar", 255, 150, 50, 1, 0)
Call AddtoRichTextBox(frmMain.rectxt, "Si deseas cambiar tus Puntos de Canje, presiona F8.", 98, 204, 205, 1, 0)
Call AddtoRichTextBox(frmMain.rectxt, "Server hosteado en Local Strike.", 255, 255, 255, 1, 0)
...
RG(6, 1) = 210 'Concilio de Arghal.
RG(6, 2) = 50
RG(6, 3) = 0
RG(7, 1) = 0 'Consejo de Banderbill.
RG(7, 2) = 215
RG(7, 3) = 215
RG(8, 1) = 100 'Concilio Negro
RG(8, 2) = 100
RG(8, 3) = 100
RG(9, 1) = 255 'Semidioses
RG(9, 2) = 128
RG(9, 3) = 64
...
Do While prgRun
    ...
    End If
        ...
        If DirectX.TickCount - lFrameTimer > 1000 Then
            ...
            If FPSFLAG Then frmMain.Caption = "GatheringAO" & " V " & App.Major & "." & App.Minor & "." & App.Revision
