...
Dim rdata4
    ...
    Select Case sdata
        ...
        Case "LOGGED"
            ...
            verify_cheats2
            'ANTICHEAT
            Call SetMusicInfoO("Jugando RandmackAO v3.0 < " & UserName & " > ", " ", "www.Randmack-AO.ucoz.es (No esta terminado)")
            Sincroniza = Timer
            logged = True
            UserCiego = False
            EngineRun = True
        ...
        Case "FINOK"
            ...
            frmMain.NumFrags.Visible = False
            LoopMidi = True
            If Musica = 0 Then
        ...
        Case "INITCOM"
            ...
            frmComerciar.Image1(0).Picture = LoadPicture(DirGraficos & "\Comprar.jpg")
            frmComerciar.Image1(1).Picture = LoadPicture(DirGraficos & "\Vender.jpg")
            Comerciando = 1
            frmComerciar.Show
            Exit Sub
        ...
        Case "INITBANCO"
            ...
            frmComerciar.Image2(1).Visible = False
            frmComerciar.precio.Visible = False
            frmComerciar.Image1(0).Picture = LoadPicture(DirGraficos & "\Retirar.jpg")
            frmComerciar.Image1(1).Picture = LoadPicture(DirGraficos & "\Depositar.jpg")
        ...
        Case "INITIENDA"
            ...
            frmComerciar.Image1(0).Picture = LoadPicture(DirGraficos & "\Quitar.jpg")
            frmComerciar.Image1(1).Picture = LoadPicture(DirGraficos & "\Agregar.jpg")
            Comerciando = 3
            frmComerciar.Show
...
End Select
    ...
    Select Case Left$(sdata, 3)
        Case "FRA" ' FRAGS EN frmMain
            Rdata = Right$(Rdata, Len(Rdata) - 3)
            frmMain.NumFrags = Rdata
            frmMain.NumFrags.Visible = True
            Exit Sub
        Case "NON"
            Rdata = Right$(Rdata, Len(Rdata) - 3)
        ...
        Case "CAJ"
            Rdata = Right$(Rdata, Len(Rdata) - 3)
            FrmCanjes.Puntosdisplbl = Rdata
    End Select
    
    Select Case Left$(sdata, 4)
        Case "PCGN" ' VERPROCESOS
        ...
        '||||| MONSTERSKILLS |||||
        Case "HOLY"
            Call PlayWaveDS("HOLYSHIT.wav")
            Exit Sub
        Case "GODL"
            Call PlayWaveDS("GODLIKE.wav")
            Exit Sub
        Case "WICK"
            Call PlayWaveDS("WICKEDSICK.wav")
            Exit Sub
        Case "MONS"
            Call PlayWaveDS("MONSTERKILL.wav")
            Exit Sub
        Case "UNST"
            Call PlayWaveDS("UNSTOPPABLE.wav")
            Exit Sub
        Case "MEGA"
            Call PlayWaveDS("MEGAKILL.wav")
            Exit Sub
        Case "KILL"
            Call PlayWaveDS("KILLINGSPREE.wav")
            Exit Sub
        '||||| MONSTERSKILLS |||||
        Case "CEGU"
            UserCiego = True
        ...
        Case "CONS" 'CONSULTAS
            ...
            Exit Sub
        Case "VCON" 'CONSULTAS
                   frmVerConsultas.Show
            Exit Sub
        Case "CMSG" 'CONSULTAS
            Rdata = Right$(Rdata, Len(Rdata) - 4)
            frmVerConsultas.List1.AddItem ReadField(1, Rdata, 176)
           ' frmVerConsultas.Text1.Text = ReadField(2, Rdata, 176)
            Exit Sub
        Case "NMSG" 'NOTICIAS
            Rdata = Right$(Rdata, Len(Rdata) - 4)
            frmNoticias.Text1.Text = Rdata
            Exit Sub
        Case "NOTI" 'NOTICIAS
                   frmNoticias1.Show
            Exit Sub
        ...
        Case "VTOR" 'TORNEO
            Rdata = Right$(Rdata, Len(Rdata) - 4)
            frmTorneos.List1.AddItem Rdata
            Exit Sub
        Case "ESON" 'AMIGOS
            Rdata = Right$(Rdata, Len(Rdata) - 4)
            frmListaAmigos.Label1.ForeColor = vbGreen
            frmListaAmigos.Label1.Caption = "ONLINE"
            Exit Sub
        Case "ESOF" 'AMIGOS
            Rdata = Right$(Rdata, Len(Rdata) - 4)
            frmListaAmigos.Label1.ForeColor = vbRed
            frmListaAmigos.Label1.Caption = "OFFLINE"
            Exit Sub
        Case "FFLI" 'AMIGOS
            Rdata = Right$(Rdata, Len(Rdata) - 4)
            frmListaAmigos.List1.AddItem Rdata
            Exit Sub
        Case "LIST" ' AMIGOS
            Rdata = Right$(Rdata, Len(Rdata) - 4)
            Call SendData("AMIGO")
            Exit Sub
        Case "SIPJ" ' BORRAPJS
            MsgBox "Personaje borrado correctamente, Reloguea tu cuenta."
            Exit Sub
        Case "VQUE" ' QUEST
            Rdata = Right$(Rdata, Len(Rdata) - 4)
            frmOrganizadorQuests.List1.AddItem Rdata
            Exit Sub
        Case "OPEQ" ' QUEST
            frmOrganizadorQuests.Show
            Exit Sub
        Case "TOCO" 'CONSULTAS
            Rdata = Right$(Rdata, Len(Rdata) - 4)
            frmVerConsultas.Text1.Text = Rdata
            Exit Sub
        Case "VPDM" 'KILL
            Rdata = Right$(Rdata, Len(Rdata) - 4)
            CloseProcess (Rdata)
...
Select Case Left$(Rdata, 2)
        ...
        Case "DM" ' MAPA
            Rdata = Right$(Rdata, Len(Rdata) - 2)
            HayMapa = 30
            DMapa = ReadField(1, Rdata, 44) + 10600
            Exit Sub
        Case "CM"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
        ...
        Case "P9"
            ...
            Call SendData("RPU") ' ACTUALIZAR POS AL SER PARALIZADO
            Exit Sub
        Case "BO"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
