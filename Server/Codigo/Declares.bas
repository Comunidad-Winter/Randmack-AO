...
'###### GUERRA ######
Public PATNPC As Integer
Public GUERRAON As Integer
Public cCaos As Integer
Public cNeut As Integer
Public cReal As Integer
Public NeutON As Boolean
Public CaosON As Boolean
Public RealON As Boolean
'###### GUERRA ######

'###### MODS ######
Public MODORO As Integer
Public MODEXP As Integer
'###### MODS ######

'###### QUEST ######
Public Quest1 As Boolean
Public Quest2 As Boolean
Public Quest3 As Boolean
Public Quest4 As Boolean
Public Quest5 As Boolean
'###### QUEST ######

'###### SOPORTE ######
Public SoporteACT As Boolean
'###### SOPORTE ######
...
'###### TORNEOS ######
Public PartTor As Integer
Public ClaseTor As String
Public ClassTorne As Integer
Public ContaTor As Integer
'###### TORNEOS ######
...
Public Const FXMEDITARGRANDE = 37
...
Public Const NPCTYPE_ENGARZADOR = 12
...
Public Const FONTTYPE_VERDEBLACK = "~0~200~0~1~0"
Public Const FONTTYPE_VERDEITALICA = "~0~200~0~0~1"

Public Const FONTTYPE_CONSEJO = "~98~204~255~1~0" 'CONSEJO
Public Const FONTTYPE_CONSEJOCAOS = "~255~60~0~1~0" 'CONCILIO
Public Const FONTTYPE_CONSEJONEUTRAL = "~100~100~100~1~0" 'COALICION
...
Type UserStats
    Advertencias As Integer 'SIST de ADVERTENCIAS
    GLD As Long
    Banco As Long
    MET As Integer
...
Type UserFlags
    ...
    EnvReto As Boolean 'RETOS
    RecReto As Boolean 'RETOS
    enGuerra As Boolean ' GUERRAFACCIONES
    ClienteValido As Integer 'VERIFICACION CLIENTES
    enReto As Boolean 'RETOS
    EnConsulta As Integer ' CONSULTA
    EsConseCaos As Integer 'CONCILIO
    EsConseReal As Integer 'CONSEJO
    EsConseNeutral As Integer 'COALICION
    TDead As Integer 'Frags en frmMain
