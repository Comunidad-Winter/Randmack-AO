...
End Sub
Function EsConsejoReal(ByVal Name As String) As Boolean
Dim NumWizs As Integer
Dim WizNum As Integer
Dim NomB As String
NumWizs = val(GetVar(IniPath & "Server.ini", "INIT", "ConsejoReal"))
For WizNum = 1 To NumWizs
    NomB = UCase$(GetVar(IniPath & "Server.ini", "ConsejoReal", "Nombre" & WizNum))
    If Left$(NomB, 1) = "*" Or Left$(NomB, 1) = "+" Then NomB = Right$(NomB, Len(NomB) - 1)
    If UCase$(Name) = NomB Then
        EsConsejoReal = True
        Exit Function
...
Function EsConsejoCaos(ByVal Name As String) As Boolean
Dim NumWizs As Integer
Dim WizNum As Integer
Dim NomB As String
NumWizs = val(GetVar(IniPath & "Server.ini", "INIT", "ConsejoCaos"))
For WizNum = 1 To NumWizs
    NomB = UCase$(GetVar(IniPath & "Server.ini", "ConsejoCaos", "Nombre" & WizNum))
    If Left$(NomB, 1) = "*" Or Left$(NomB, 1) = "+" Then NomB = Right$(NomB, Len(NomB) - 1)
    If UCase$(Name) = NomB Then
        EsConsejoCaos = True
        Exit Function
...
Function EsConsejoNeutral(ByVal Name As String) As Boolean
Dim NumWizs As Integer
Dim WizNum As Integer
Dim NomB As String
NumWizs = val(GetVar(IniPath & "Server.ini", "INIT", "ConsejoNeutral"))
For WizNum = 1 To NumWizs
    NomB = UCase$(GetVar(IniPath & "Server.ini", "ConsejoNeutral", "Nombre" & WizNum))
    If Left$(NomB, 1) = "*" Or Left$(NomB, 1) = "+" Then NomB = Right$(NomB, Len(NomB) - 1)
    If UCase$(Name) = NomB Then
        EsConsejoNeutral = True
        Exit Function
    End If
Next
End Function
