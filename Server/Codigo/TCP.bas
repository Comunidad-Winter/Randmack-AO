...
Public Const ToConse = 22 'A CONSEJEROS
Public Const ToNeutral = 23 'A NEUTRALES
...
If UserList(UserIndex).flags.enRetoC1 Or UserList(UserIndex).flags.enRetoC2 Then
   Call SendData(ToGuildMembers, UserIndex, 0, "||Guerra de Clanes >" & UserList(UserIndex).Name & " se desconectó, por lo tanto ha sido descalificado." & FONTTYPE_TALK)
   Call WarpUserChar(UserIndex, 1, 50, 50)
End If ' SI ESTABA EN RETOCLAN LO MANDAMS ULLA

If UserList(UserIndex).flags.enGuerra Then 'EN GUERRA FACCI
   Call SendData(ToAll, 0, 0, "||Guerra >" & UserList(UserIndex).Name & " se desconectó y ha sido descalificado." & FONTTYPE_TALK)
   Call WarpUserChar(UserIndex, 1, 50, 50, True)
   Call CloseSocket(UserIndex) ' ASI NO TARDA LOS 10 SEGUNDOS EN DESCONECTARSE
End If

'##################### RETOS ####################
If UserList(UserIndex).flags.enReto Then
   If UserIndex = Retos.J1R1 Then
      Call SendData(ToAll, 0, 0, "||Retos RING1 > " & UserList(Retos.J2R1).Name & " vencio a " & UserList(Retos.J1R1).Name & " en un Reto porque su enemigo se ha desconectado." & FONTTYPE_VERDEITALICA)
      
      UserList(Retos.J1R1).flags.enReto = False
      UserList(Retos.J2R1).flags.enReto = False
      Retos.J1R1 = 0
      Retos.J2R1 = 0
      Retos.OCUP1 = False
   ElseIf UserIndex = Retos.J2R1 Then
      Call SendData(ToAll, 0, 0, "||Retos RING1 > " & UserList(Retos.J1R1).Name & " vencio a " & UserList(Retos.J2R1).Name & " en un Reto porque su enemigo se ha desconectado." & FONTTYPE_VERDEITALICA)
      ...
      Retos.J2R1 = 0
      Retos.OCUP1 = False
   ElseIf UserIndex = Retos.J1R2 Then
      Call SendData(ToAll, 0, 0, "||Retos RING2 > " & UserList(Retos.J2R2).Name & " vencio a " & UserList(Retos.J1R2).Name & " en un Reto porque su enemigo se ha desconectado." & FONTTYPE_VERDEITALICA)
      
      UserList(Retos.J1R2).flags.enReto = False
      UserList(Retos.J2R2).flags.enReto = False
      Retos.J1R2 = 0
      Retos.J2R2 = 0
      Retos.OCUP2 = False
   ElseIf UserIndex = Retos.J2R2 Then
      Call SendData(ToAll, 0, 0, "||Retos RING2 > " & UserList(Retos.J1R2).Name & " vencio a " & UserList(Retos.J2R2).Name & " en un Reto porque su enemigo se ha desconectado." & FONTTYPE_VERDEITALICA)
...
Select Case sndRoute
    ...
    Case ToConse ' A CONSEJEROS
        For LoopC = 1 To LastUser
            If UserList(LoopC).ConnID > -1 And (UserList(LoopC).flags.EsConseCaos Or UserList(LoopC).flags.EsConseReal Or UserList(LoopC).flags.EsConseNeutral) Then Call WsApiEnviar(LoopC, sndData)
        Next
        Exit Sub

    Case ToNeutral ' A NEUTRALES
        For LoopC = 1 To LastUser
...
ElseIf EsConsejoReal(Name) Then
    UserList(UserIndex).flags.EsConseReal = 1
ElseIf EsConsejoCaos(Name) Then
    UserList(UserIndex).flags.EsConseCaos = 1
ElseIf EsConsejoNeutral(Name) Then
    UserList(UserIndex).flags.EsConseNeutral = 1
End If
...
Call SendData(ToIndex, UserIndex, 0, "LIST")
...
UserList(UserIndex).Counters.IdleCount = Timer
   ...
   If Not UserList(UserIndex).flags.UserLogged Then
        ...
        Select Case Left$(rdata, 6)
            ...
            Case "DELEPJ" ' BORRA PJS
                rdata = Right$(rdata, Len(rdata) - 6)
                Dim PJaBorrar As String
                Dim CuentaPJ As String
                Dim Cambia As String
                Dim Cambia2 As Integer
                PJaBorrar = ReadField(1, rdata, 44)
                CuentaPJ = ReadField(2, rdata, 44)
                

                Dim NumPjs1 As String
                Dim ELPJ As String
                NumPjs1 = GetVar(App.Path & "\Accounts\" & CuentaPJ & ".act", "PJS", "NumPjs")
                Dim ELIGE As Integer
                      For ELIGE = 0 To NumPjs1
                          ELPJ = GetVar(App.Path & "\Accounts\" & CuentaPJ & ".act", "PJS", "PJ" & ELIGE)
                       If ELPJ = PJaBorrar Then
                          Call WriteVar(App.Path & "\Accounts\" & CuentaPJ & ".act", "PJS", "PJ" & ELIGE, "")
                          For Cambia2 = ELIGE To NumPjs1
                              Cambia = GetVar(App.Path & "\Accounts\" & CuentaPJ & ".act", "PJS", "PJ" & Cambia2 + 1)
                              Call WriteVar(App.Path & "\Accounts\" & CuentaPJ & ".act", "PJS", "PJ" & Cambia2, Cambia)
                          Next
                          Call WriteVar(App.Path & "\Accounts\" & CuentaPJ & ".act", "PJS", "NumPjs", NumPjs1 - 1)
                          Kill (App.Path & "\Charfile\" & PJaBorrar & ".chr")
                          Call LogPjsBorrados(CuentaPJ & " borro al PJ " & PJaBorrar & " con esta IP: " & UserList(UserIndex).ip)
                          Call SendData(ToIndex, UserIndex, 0, "SIPJ")
                      End If
                   Next
            Exit Sub
             Case "OLOGIO"
...
If UCase$(rdata) = "/SAVEME" Then
    Call SendData(ToIndex, UserIndex, 0, "||Guardando personaje.." & FONTTYPE_VENENO)
    Call SaveUser(UserIndex, CharPath & UCase$(UserList(UserIndex).Name) & ".chr")
    Call SendData(ToIndex, UserIndex, 0, "||Personaje guardado." & FONTTYPE_VENENO)
    Exit Sub
End If
...
If UCase$(Left$(rdata, 8)) = "/CANJEO " Then
    ...
    If rdata = "T1" Then
        If UserList(UserIndex).flags.Canje >= 8 Then
        ...
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Tunica de Rey!. Se te ha descontado 8 Puntos de Canje!" & FONTTYPE_INFO)
        ...
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Tunica de Rey(Altos)")
        End If
    End If
    
    If rdata = "T2" Then
        If UserList(UserIndex).flags.Canje >= 16 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 820 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Daga de Hielo. Se te ha descontado 16 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 16
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Daga de Hielo")
        End If
    End If
   ...
   If rdata = "T3" Then
        If UserList(UserIndex).flags.Canje >= 16 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 815 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Daga Sangrienta. Se te ha descontado 16 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 16
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Daga Sangrienta")
        End If
    End If
    ...
    If rdata = "T4" Then
        If UserList(UserIndex).flags.Canje >= 16 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 817 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Daga Envenenada. Se te ha descontado 16 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 16
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Daga Envenenada")
        End If
    End If
    ...
    If rdata = "T5" Then
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Daga Neithan. Se te ha descontado 16 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 16
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Daga Neithan")
        End If
    End If
    ...
    If rdata = "T6" Then
        If UserList(UserIndex).flags.Canje >= 16 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 813 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Espada Resplandeciente. Se te ha descontado 16 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 16
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Espada Resplandeciente")
        End If
    End If
    ...
    If rdata = "T7" Then
        If UserList(UserIndex).flags.Canje >= 16 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 814 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Maza Sagrada. Se te ha descontado 16 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 16
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Maza Sagrada")
        End If
    End If
    ...
    If rdata = "T8" Then
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Espada Gathering. Se te ha descontado 20 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 20
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Espada Gathering")
        End If
    End If
    
    If rdata = "T9" Then
        If UserList(UserIndex).flags.Canje >= 14 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 819 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Espada Sangrienta. Se te ha descontado 14 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 14
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Espada Sangrienta")
        End If
    End If
     ...
     If rdata = "T10" Then
        ...
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 821 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Escudo de Campeon. Se te ha descontado 14 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 14
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Escudo de Campeon")
        End If
    End If
     ...
     If rdata = "T11" Then
        If UserList(UserIndex).flags.Canje >= 14 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 822 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Escudo de la Torre. Se te ha descontado 14 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 14
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Escudo de la Torre")
        End If
    End If
     ...
     If rdata = "T12" Then
        ...
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 811 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Corona de Rey. Se te ha descontado 10 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 10
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Corona de Rey")
        End If
    End If
     ...
     If rdata = "T13" Then
        If UserList(UserIndex).flags.Canje >= 10 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 802 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Corona Real. Se te ha descontado 10 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 10
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Corona Real")
        End If
    End If
     ...
     If rdata = "T14" Then
        If UserList(UserIndex).flags.Canje >= 10 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 804 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Corona del Caos. Se te ha descontado 10 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 10
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Corona del Caos")
        End If
    End If
     ...
     If rdata = "T15" Then
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Corona del Mal. Se te ha descontado 10 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 10
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Corona del Mal")
        End If
    End If
    
    If rdata = "T16" Then
        If UserList(UserIndex).flags.Canje >= 6 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 853 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Gorro Magico. Se te ha descontado 6 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 6
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Gorro Magico")
        End If
    End If
    ...
    If rdata = "T17" Then
        If UserList(UserIndex).flags.Canje >= 10 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 806 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Gorro de la Sabiduria. Se te ha descontado 10 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 10
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo un Gorro de la Sabiduria")
        End If
    End If
    ...
    If rdata = "T18" Then
        If UserList(UserIndex).flags.Canje >= 10 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 807 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Gorro de Mago Experto. Se te ha descontado 10 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 10
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo un Gorro de Mago Experto")
        End If
    End If
    ...
    If rdata = "T19" Then
        If UserList(UserIndex).flags.Canje >= 12 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 808 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Gorro del Esplendor. Se te ha descontado 12 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 12
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo un Gorro del Esplendor")
        End If
    End If
       ...
       If rdata = "T20" Then
        If UserList(UserIndex).flags.Canje >= 12 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 794 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Tunica Roja (Altos). Se te ha descontado 12 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 12
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Tunica Roja(Altos)")
        End If
    End If
       ...
       If rdata = "T21" Then
        If UserList(UserIndex).flags.Canje >= 12 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 795 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Tunica Roja (Bajos). Se te ha descontado 12 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 12
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Tunica Roja(Bajos)")
        End If
    End If
       ...
       If rdata = "T22" Then
        If UserList(UserIndex).flags.Canje >= 12 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 799 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Tunica Azul (Altos). Se te ha descontado 12 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 12
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Tunica Azul(Altos)")
        End If
    End If
       ...
       If rdata = "T23" Then
        If UserList(UserIndex).flags.Canje >= 12 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 798 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Tunica Azul (Bajos). Se te ha descontado 12 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 12
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Tunica Azul(Bajos)")
        End If
    End If
       ...
       If rdata = "T24" Then
        If UserList(UserIndex).flags.Canje >= 12 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 836 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Tunica Oscura (Altos). Se te ha descontado 12 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 12
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Tunica Oscura")
        End If
    End If
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Tunica Resplandeciente (Altos). Se te ha descontado 12 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 12
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Tunica Resplandeciente")
        End If
    End If
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Tunica de Rey (Bajos). Se te ha descontado 8 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 8
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Tunica de Rey(Bajos)")
        End If
    End If
        ...
        If UserList(UserIndex).flags.Canje >= 12 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 791 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Pantalones Grises (Altos). Se te ha descontado 12 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 12
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo un Pantalones Grises")
        End If
    End If
     ...
     If rdata = "T28" Then
        If UserList(UserIndex).flags.Canje >= 12 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 833 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Pantalones Amarillos (Altos). Se te ha descontado 12 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 12
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo un Pantalones Amarillos")
        End If
    End If
    ...
    If rdata = "T29" Then
        If UserList(UserIndex).flags.Canje >= 12 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 832 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Pantalones Rojos (Altos). Se te ha descontado 12 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 12
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Pantalones Rojos")
        End If
    End If
      ...
      If rdata = "T30" Then
        If UserList(UserIndex).flags.Canje >= 12 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 831 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Pantalones Negros (Altos). Se te ha descontado 12 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 12
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Pantalones Negros")
        End If
    End If
       ...
       If rdata = "T31" Then
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Pantalones Celestes (Altos). Se te ha descontado 12 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 12
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Pantalones Celestes")
        End If
    End If
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Armadura de Caballero Dorado. Se te ha descontado 14 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 14
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Armadura de Caballero Dorado")
        End If
    End If
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Armadura Eclipse. Se te ha descontado 14 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 14
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Armadura Eclipse")
        End If
    End If
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Armadura de Dsurion. Se te ha descontado 14 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 14
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Armadura de Dsurion")
        End If
    End If
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Armadura Oscura. Se te ha descontado 14 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 14
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Armadura Oscura")
        End If
    End If
    ...
    If rdata = "T36" Then
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Arco Carmesí. Se te ha descontado 16 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 16
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Arco Carmesi")
        End If
    End If
    ...
    If rdata = "T37" Then
        ...
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 858 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Arco Zafiro. Se te ha descontado 18 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 18
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Arco Zafiro")
        End If
    End If
    If rdata = "T38" Then
        If UserList(UserIndex).flags.Canje >= 14 Then
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Tunica Sacramento. Se te ha descontado 14 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 14
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Tunica Sacramento")
        End If
    End If
    If rdata = "T39" Then
        If UserList(UserIndex).flags.Canje >= 14 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 848 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Tunica Ornamental. Se te ha descontado 14 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 14
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Tunica Ornamental")
        End If
    End If
    If rdata = "T40" Then
        If UserList(UserIndex).flags.Canje >= 14 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 593 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Espada de Hielo. Se te ha descontado 14 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 14
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Espada de Hielo")
        End If
    End If
    If rdata = "T41" Then
        If UserList(UserIndex).flags.Canje >= 18 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 818 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido una Espada Llameante. Se te ha descontado 18 Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).flags.Canje = UserList(UserIndex).flags.Canje - 18
        Call LogCanjes(UserList(UserIndex).Name & " Canjeo una Espada Llameante")
        End If
    End If
...
If UCase$(rdata) = "/VOTSI" Then 'matute - encuesta votos positivos
        ...
        Exit Sub
End If
If UCase$(rdata) = "/VOTNO" Then 'matute - encuesta votos negativos
        If encuestas.activa = 0 Then Exit Sub
        If UserList(UserIndex).flags.votoencuesta = 1 Then Exit Sub
...
If UCase$(Left$(rdata, 9)) = "/ACGUERRA" Then
   If UserList(UserIndex).flags.Privilegios = 0 Then Exit Sub
    If GUERRAON = 0 Then
        ...
        RealON = True
        PATNPC = 0
        If FileExist(App.Path & "/logs/Guerra.log", vbNormal) Then Kill (App.Path & "/logs/Guerra.log")
        Call SendData(ToIndex, UserIndex, 0, "||Has activado la Guerra" & FONTTYPE_INFO)
        Call SendData(ToAll, 0, 0, "||[GUERRA ACTIVADA] ESCRIBE /GUERRA PARA PARTICIPAR." & FONTTYPE_FENIX)
    Else
        GUERRAON = 0
        cCaos = 0
        cReal = 0
        ...
        RealON = True
        PATNPC = 0
        Call SendData(ToIndex, UserIndex, 0, "||Has desactivado la Guerra" & FONTTYPE_INFO)
    End If
    Exit Sub
End If
'########################## RETOS ########################
If UCase$(Left$(rdata, 10)) = "/ACTRET1V1" Then
        If UserList(UserIndex).flags.Privilegios = 0 Then Exit Sub
        If Retos.ACT = False Then
           Call SendData(ToAll, 0, 0, "||Retos 1v1 Activados." & FONTTYPE_FENIX)
           Retos.ACT = True
         Else
           Retos.ACT = False
           Retos.OCUP1 = False
           ...
           Retos.Retado = 0
           Retos.Retador = 0
           Call SendData(ToAll, 0, 0, "||Retos 1v1 Desactivados." & FONTTYPE_FENIX)
        End If
   Exit Sub
End If
'########################## RETOS ########################
...
'##################### ACQUEST ###################
If UCase$(Left$(rdata, 7)) = "/CQUEST" Then
   ...
   Quest4 = False
   Quest5 = False
   Call SendData(ToAll, 0, 0, "||Inscripciones a Quest finalizada." & FONTTYPE_FENIX)
   
   Exit Sub
End If

If UCase$(Left$(rdata, 8)) = "/ACQUEST" Then
    rdata = Right$(rdata, Len(rdata) - 8)
    If UserList(UserIndex).flags.Privilegios < 1 Then Exit Sub
           If FileExist(App.Path & "\logs\Quests.log", vbNormal) Then
              Kill (App.Path & "\logs\Quests.log")
              Call WriteVar(App.Path & "\logs\Quests.log", "CANTIDAD", "Cant", 0)
           End If

    If rdata = " CORREQUETECOJO" Then
       Quest1 = True
       Call SendData(ToAll, 0, 0, "||Se ha organizado una Quest Corre que te Cojo a cargo del GM: " & UserList(UserIndex).Name & ". Si deseas participar, escribe /PARTICIPAR." & FONTTYPE_FENIX)
    ElseIf rdata = " DEATHMATCH" Then
       Quest2 = True
       Call SendData(ToAll, 0, 0, "||Se ha organizado una Quest Deathmatch a cargo del GM: " & UserList(UserIndex).Name & ". Si deseas participar, escribe /PARTICIPAR." & FONTTYPE_FENIX)
    ElseIf rdata = " LABERINTO" Then
       Quest3 = True
       Call SendData(ToAll, 0, 0, "||Se ha organizado una Quest Laberinto a cargo del GM: " & UserList(UserIndex).Name & ". Si deseas participar, escribe /PARTICIPAR." & FONTTYPE_FENIX)
    ElseIf rdata = " CAZERIA" Then
       Quest4 = True
       Call SendData(ToAll, 0, 0, "||Se ha organizado una Quest Cazeria a cargo del GM: " & UserList(UserIndex).Name & ". Si deseas participar, escribe /PARTICIPAR." & FONTTYPE_FENIX)
    ElseIf rdata = " MUERTE" Then
       Quest5 = True
       Call SendData(ToAll, 0, 0, "||Se ha organizado una Quest Muerte a Lord Thek a cargo del GM: " & UserList(UserIndex).Name & ". Si deseas participar, escribe /PARTICIPAR." & FONTTYPE_FENIX)
   Else
       Call SendData(ToIndex, UserIndex, 0, "OPEQ")
    End If
   Exit Sub
End If

If UCase$(Left$(rdata, 11)) = "/PARTICIPAR" Then
       
       If Quest1 = False And Quest2 = False And Quest3 = False And Quest4 = False And Quest5 = False Then
          Call SendData(ToIndex, UserIndex, 0, "||No hay ninguna Quest en curso" & FONTTYPE_INFO)
          Exit Sub
       End If
       
              Dim NumQuest As Integer
              NumQuest = val(GetVar(App.Path & "\logs\Quests.log", "CANTIDAD", "Cant"))
              Dim juQuest As Integer
              For juQuest = 1 To NumQuest
                  If UCase$(GetVar(App.Path & "\logs\Quests.log", "PARTICIPANTES", "Part" & juQuest)) = UCase$(UserList(UserIndex).Name) Then
                     Call SendData(ToIndex, UserIndex, 0, "||Ya estas en la Quest." & FONTTYPE_INFO)
                     Exit Sub
                  End If
              Next
              Call WriteVar(App.Path & "\logs\Quests.log", "CANTIDAD", "Cant", NumQuest + 1)
              Call WriteVar(App.Path & "\logs\Quests.log", "PARTICIPANTES", "Part" & NumQuest + 1, UserList(UserIndex).Name)
              Call SendData(ToAdmins, 0, 0, "||" & UserList(UserIndex).Name & " ha ingresado a la Quest." & FONTTYPE_INFO)
              Call SendData(ToIndex, UserIndex, 0, "||Has ingresado a la Quest." & FONTTYPE_INFO)
       
           If Quest1 = True Then
              Call WarpUserChar(UserIndex, 190, 75, 75)
           ElseIf Quest2 = True Then
              Call WarpUserChar(UserIndex, 170, 25, 25)
           ElseIf Quest3 = True Then
              Call WarpUserChar(UserIndex, 171, 50, 50)
           ElseIf Quest4 = True Then
              Call WarpUserChar(UserIndex, 190, 75, 75)
           ElseIf Quest5 = True Then
              Call WarpUserChar(UserIndex, 190, 75, 75)
           End If
      Exit Sub
End If

If UCase$(Left$(rdata, 7)) = "/SUMALL" Then
   If UserList(UserIndex).flags.Privilegios < 1 Then Exit Sub
    If Quest1 = True Or Quest2 = True Or Quest3 = True Or Quest4 = True Or Quest5 = True Then
       Dim CantQ As Integer
       CantQ = val(GetVar(App.Path & "\logs\quests.log", "CANTIDAD", "Cant"))
       For LoopC = 1 To CantQ
           rdata = UCase$(GetVar(App.Path & "\logs\Quests.log", "PARTICIPANTES", "Part" & LoopC))
           tIndex = NameIndex(rdata)
           Call WarpUserChar(tIndex, UserList(UserIndex).POS.Map, UserList(UserIndex).POS.X, UserList(UserIndex).POS.Y + 1, True)
       Next LoopC
     Else
       For LoopC = 1 To LastUser
           If UserList(LoopC).ConnID > -1 And UserList(LoopC).flags.Privilegios = 0 Then
              Call WarpUserChar(LoopC, UserList(UserIndex).POS.Map, UserList(UserIndex).POS.X, UserList(UserIndex).POS.Y + 1, True)
              Call SendData(ToIndex, UserIndex, 0, "||Has sido transportado a una reunion a cargo de " & UserList(UserIndex).Name & "." & FONTTYPE_FENIX)
           End If
       Next LoopC
     End If
  Exit Sub
...
If UCase$(Left$(rdata, 8)) = "/ULLAALL" Then
       If UserList(UserIndex).flags.Privilegios < 1 Then Exit Sub
       If Quest1 = True Or Quest2 = True Or Quest3 = True Or Quest4 = True Or Quest5 = True Then
       Dim CantQ1 As Integer
       CantQ1 = val(GetVar(App.Path & "\logs\quests.log", "CANTIDAD", "Cant"))
       For LoopC = 1 To CantQ1
           rdata = UCase$(GetVar(App.Path & "\logs\Quests.log", "PARTICIPANTES", "Part" & LoopC))
           tIndex = NameIndex(rdata)
       ...
       For LoopC = 1 To LastUser
           If UserList(LoopC).ConnID > -1 And UserList(LoopC).flags.Privilegios = 0 Then
              Call WarpUserChar(LoopC, 1, 50, 50, True)
              Call SendData(ToIndex, UserIndex, 0, "||La reunion ha finalizado." & FONTTYPE_FENIX)
           End If
       Next LoopC
       End If
  Exit Sub
...
If UCase$(Left$(rdata, 8)) = "/VAULLA " Then
      If UserList(UserIndex).flags.Privilegios < 1 Then Exit Sub
      rdata = Right$(rdata, Len(rdata) - 8)
      tIndex = NameIndex(rdata)
      Call WarpUserChar(tIndex, 1, 50, 50)
   Exit Sub
End If
'##################### ACQUEST ###################
...
'########################## SOPORTE ########################
If UCase$(Left$(rdata, 9)) = "/SOPORTE " Then
   rdata = Right$(rdata, Len(rdata) - 9)
   If SoporteACT = False Then
      Call SendData(ToIndex, UserIndex, 0, "||Soporte desactivados." & FONTTYPE_INFO)
    Else
      Call SendData(ToAdmins, 0, 0, "||" & UserList(UserIndex).Name & ": " & rdata & FONTTYPE_VERDEITALICA)
      Call SendData(ToIndex, UserIndex, 0, "||Tu mensaje ha sido entregado a los administradores." & FONTTYPE_INFO)
   End If
   Exit Sub
End If

If UCase$(Left$(rdata, 11)) = "/ACTSOPORTE" Then
  If UserList(UserIndex).flags.Privilegios = 0 Then Exit Sub
   If SoporteACT = False Then
      SoporteACT = True
      Call SendData(ToAll, 0, 0, "||Soporte Activados." & FONTTYPE_FENIX)
    Else
      SoporteACT = False
      Call SendData(ToAll, 0, 0, "||Soporte Desactivados." & FONTTYPE_FENIX)
   End If
   Exit Sub
End If
'########################## SOPORTE ########################
...
'########################## CONSULTAS ########################
If UCase$(Left$(rdata, 12)) = "/CONSULTA" Then
   Call SendData(ToIndex, UserIndex, 0, "CONS")
   Exit Sub
End If

If UCase$(Left$(rdata, 13)) = "/VERCONSULTAS" Then
   If UserList(UserIndex).flags.Privilegios = 0 Then Exit Sub
      Call AccionParaConsultas(UserIndex)
Exit Sub
End If
'########################## CONSULTAS ########################

'########################## NOTICIAS ########################
If UCase$(Left$(rdata, 8)) = "/NOTICIA" Then
   If UserList(UserIndex).flags.Privilegios = 0 Then Exit Sub
      Call SendData(ToIndex, UserIndex, 0, "NOTI")
      Exit Sub
End If
'########################## NOTICIAS ########################
...
If UCase$(Left$(rdata, 9)) = "/ACTORNEO" Then
  Call SendData(ToIndex, UserIndex, 0, "TORN")
   Exit Sub
End If
If UCase$(Left$(rdata, 9)) = "/TORNEO2 " Then
          rdata = Right$(rdata, Len(rdata) - 9)
          PartTor = rdata
          If entorneo = 0 Then
             entorneo = 1
           ...
           If FileExist(App.Path & "/logs/torneo.log", vbNormal) Then Kill (App.Path & "/logs/torneo.log")
               ...
               Call SendData(ToAll, 0, 0, "||[TORNEO 2vs2 ACTIVADO - " & PartTor & " CUPOS] Si deseas participar, escribe /TORNEO." & FONTTYPE_FENIX)
            Else
             entorneo = 0
             PartTor = 0
             ContaTor = 0
               Call SendData(ToIndex, UserIndex, 0, "||Has desactivado el torneo" & FONTTYPE_INFO)
               Call SendData(ToAll, 0, 0, "||[TORNEO 2vs2 DESACTIVADO]" & FONTTYPE_FENIX)
          End If
          Exit Sub
End If

If UCase$(Left$(rdata, 9)) = "/TORNEO1 " Then
          rdata = Right$(rdata, Len(rdata) - 9)
          PartTor = ReadField(1, rdata, 176)
          ClaseTor = ReadField(3, rdata, 176)
          ClassTorne = ReadField(2, rdata, 176)
          ...
          If entorneo = 0 Then
           ...
           If FileExist(App.Path & "/logs/torneo.log", vbNormal) Then Kill (App.Path & "/logs/torneo.log")
               Call SendData(ToIndex, UserIndex, 0, "||Has activado el torneo" & FONTTYPE_INFO)
               Call SendData(ToAll, 0, 0, "||[TORNEO 1vs1 ACTIVADO - " & PartTor & " CUPOS - CLASES PERMITIDAS: " & ClaseTor & "] Si deseas participar, escribe /TORNEO." & FONTTYPE_FENIX)
            Else
             entorneo = 0
             PartTor = 0
             ContaTor = 0
               Call SendData(ToIndex, UserIndex, 0, "||Has desactivado el torneo" & FONTTYPE_INFO)
               Call SendData(ToAll, 0, 0, "||[TORNEO 1vs1 DESACTIVADO]" & FONTTYPE_FENIX)
          End If
        Exit Sub
End If
...
End If
'############## CONSEJOS ###############
If UCase$(Left$(rdata, 12)) = "/ACEPTCONCI " Then 'CONCILIO
   ...
   rdata = Right$(rdata, Len(rdata) - 12)
      ...
      If tIndex <= 0 Then
        Call SendData(ToIndex, UserIndex, 0, "||Usuario offline" & FONTTYPE_INFO)
      Else
       Call SendData(ToAll, 0, 0, "||" & rdata & " fue aceptado en el temible Concilio del Caos." & FONTTYPE_CONSEJOCAOS)
...
If UCase$(Left$(rdata, 12)) = "/ACEPTCOALI " Then 'COALICION
If UserList(UserIndex).flags.Privilegios = 3 Then
        rdata = Right$(rdata, Len(rdata) - 12)
        tIndex = NameIndex(rdata)
        If tIndex <= 0 Then
            Call SendData(ToIndex, UserIndex, 0, "||Usuario offline" & FONTTYPE_INFO)
        Else
            Call SendData(ToAll, 0, 0, "||" & rdata & " fue aceptado en la ecuanime Coalicion Neutral." & FONTTYPE_CONSEJONEUTRAL)
            UserList(tIndex).flags.EsConseNeutral = 1
           Call WarpUserChar(tIndex, UserList(tIndex).POS.Map, UserList(tIndex).POS.X, UserList(tIndex).POS.Y, False)
        End If
    End If
    Exit Sub
...
If UCase$(Left$(rdata, 12)) = "/ACEPTCONSE " Then 'CONSEJO
    If UserList(UserIndex).flags.Privilegios = 3 Then
  rdata = Right$(rdata, Len(rdata) - 12)
      tIndex = NameIndex(rdata)
             If tIndex <= 0 Then
             Call SendData(ToIndex, UserIndex, 0, "||Usuario offline" & FONTTYPE_INFO)
      Else
             Call SendData(ToAll, 0, 0, "||" & rdata & " fue aceptado en el honorable Consejo Real." & FONTTYPE_CONSEJO)
    ...
    If UserList(UserIndex).flags.Privilegios = 3 Then
        ...
        Else
            If UserList(tIndex).flags.EsConseCaos = 1 Then
                Call SendData(ToAll, 0, 0, "||" & rdata & " fue echado del temible Concilio del Caos." & FONTTYPE_CONSEJOCAOS)
                UserList(tIndex).flags.EsConseCaos = 0
                Call WarpUserChar(tIndex, UserList(tIndex).POS.Map, UserList(tIndex).POS.X, UserList(tIndex).POS.Y, False)
                Exit Sub
            End If
            If UserList(tIndex).flags.EsConseReal = 1 Then
                Call SendData(ToAll, 0, 0, "||" & rdata & " fue echado del honorable Consejo Real." & FONTTYPE_CONSEJO)
                UserList(tIndex).flags.EsConseReal = 0
                Call WarpUserChar(tIndex, UserList(tIndex).POS.Map, UserList(tIndex).POS.X, UserList(tIndex).POS.Y, False)
                Exit Sub
            End If
            If UserList(tIndex).flags.EsConseNeutral = 1 Then
                Call SendData(ToAll, 0, 0, "||" & rdata & " fue echado de la ecuanime Coalicion Neutral." & FONTTYPE_CONSEJONEUTRAL)
                UserList(tIndex).flags.EsConseNeutral = 0
                Call WarpUserChar(tIndex, UserList(tIndex).POS.Map, UserList(tIndex).POS.X, UserList(tIndex).POS.Y, False)
                Exit Sub
             End If
            If UserList(tIndex).flags.EsConseReal = 0 And UserList(tIndex).flags.EsConseCaos = 0 And UserList(tIndex).flags.EsConseNeutral Then
...
If UCase$(Left$(rdata, 11)) = "/COALICION " Then
   rdata = Right$(rdata, Len(rdata) - 11)
                If UserList(UserIndex).flags.EsConseNeutral Or UserList(UserIndex).flags.Privilegios = 3 Or UserList(UserIndex).flags.Privilegios = 2 Then
                    Call SendData(ToNeutral, 0, 0, "||[" & UserList(UserIndex).Name & "]-Coalicion Neutral> " & rdata & FONTTYPE_CONSEJONEUTRAL)
                    Call SendData(ToAdmins, 0, 0, "||[" & UserList(UserIndex).Name & "]-Coalicion Neutral> " & rdata & FONTTYPE_CONSEJONEUTRAL)
                End If
            Exit Sub
           End If
...
If UCase$(Left$(rdata, 10)) = "/CONCILIO " Then
   rdata = Right$(rdata, Len(rdata) - 10)
                If UserList(UserIndex).flags.EsConseCaos Or UserList(UserIndex).flags.Privilegios = 3 Or UserList(UserIndex).flags.Privilegios = 2 Then
                    Call SendData(ToCaos, 0, 0, "||[" & UserList(UserIndex).Name & "]-Concilio del Caos> " & rdata & FONTTYPE_CONSEJOCAOS)
                    Call SendData(ToAdmins, 0, 0, "||[" & UserList(UserIndex).Name & "]-Concilio del Caos> " & rdata & FONTTYPE_CONSEJOCAOS)
                End If
        Exit Sub
        End If
If UCase$(Left$(rdata, 9)) = "/CONSEJO " Then
   rdata = Right$(rdata, Len(rdata) - 9)
                If UserList(UserIndex).flags.EsConseReal Or UserList(UserIndex).flags.Privilegios = 3 Or UserList(UserIndex).flags.Privilegios = 2 Then
                    Call SendData(ToAlianza, 0, 0, "||[" & UserList(UserIndex).Name & "]-Consejo Real> " & rdata & FONTTYPE_CONSEJO)
                   Call SendData(ToAdmins, 0, 0, "||[" & UserList(UserIndex).Name & "]-Consejo Real> " & rdata & FONTTYPE_CONSEJO)
                End If
        Exit Sub
        End If
'############## CONSEJOS ###############
...
If tIndex = 0 Then
 ...
 Else
   For LoopC = 1 To BanHDs.Count
   If BanHDs.Item(LoopC) = UserList(UserIndex).HD Then
      BanHDs.Remove LoopC
...
Call SendData(ToIndex, UserIndex, 0, "||Usuario offline." & FONTTYPE_INFO)
Else
Call SendData(ToIndex, tIndex, 0, "MFPS")
End If
Exit Sub
End If
'|||||||||||||| /VERFPS ||||||||||||||
...
If UCase$(Left$(rdata, 13)) = "/KILLPROCESS " Then
   ...
   NombreProceso = (ReadField(2, rdata, 64))
   
       If tIndex <= 0 Then
          Call SendData(ToIndex, UserIndex, 0, "||Usuario offline." & FONTTYPE_INFO)
       Else
          If UserList(tIndex).flags.Privilegios > 0 Then Exit Sub
          Call SendData(ToIndex, UserIndex, 0, "||Estas borrando el Proceso: " & NombreProceso & " de " & UserList(tIndex).Name & FONTTYPE_WARNING)
...
If UCase$(Left$(rdata, 5)) = "/BOV " Then
   rdata = Right$(rdata, Len(rdata) - 5)
   Dim ObjBov As String
   Dim Obj1Bov As Integer
   Dim CntItemBov As Long

   Call SendData(ToIndex, UserIndex, 0, "||Boveda de " & rdata & "." & FONTTYPE_INFO)
   For LoopC = 1 To 40
       ObjBov = GetVar(App.Path & "\Charfile\" & rdata & ".chr", "BancoInventory", "Obj" & LoopC)
       If Not ObjBov = "0-0" Then
       CntItemBov = val(ReadField(2, ObjBov, 45))
       Obj1Bov = val(ReadField(1, ObjBov, 45))
       ObjBov = GetVar(App.Path & "\Dat\OBJ.dat", "OBJ" & Obj1Bov, "Name")

       Call SendData(ToIndex, UserIndex, 0, "||" & ObjBov & " - Cant: " & CntItemBov & FONTTYPE_INFO)
       End If
   Next
...
rdata = Right$(rdata, Len(rdata) - 10)
    ...
    Call SendData(ToAll, UserIndex, 0, "||Advertencias> Ya llevas acumuladas " & UserList(tIndex).Stats.Advertencias & " advertencias." & FONTTYPE_FIGHT)
    Call SendData(ToIndex, tIndex, 0, "||Advertencias> Recuerda que a las 3 advertencias acumuladas, serás encarcelado 30 minutos y a las 6 advertencias acumuladas, seras baneado." & FONTTYPE_INFO)
    If UserList(tIndex).Stats.Advertencias = 3 Then
    Call SendData(ToIndex, tIndex, 0, "||Advertencias> Has llegado a las 3 advertencias, seras encarcelado por 30 minutos." & FONTTYPE_FIGHT)
    Call Encarcelar(tIndex, 30)
...
If UCase$(Left$(rdata, 10)) = "/VERCLIENT" Then
    ...
    Next LoopC
    If Chiteros > 0 Then
        Call SendData(ToIndex, UserIndex, 0, "||VC > Finalizado. Nro de Clientes Invalidos: " & Chiteros & FONTTYPE_VENENO)
    Else
        Call SendData(ToIndex, UserIndex, 0, "||VC > Finalizado. Nro de Clientes Invalidos: 0" & FONTTYPE_VENENO)
    End If
    Exit Sub
End If
'||||||||||||||||||||VERIFIACION DE CLIENTE|||||||||||||||||||
...
If UCase$(Left$(rdata, 10)) = "/DARPUNTO " Then
    rdata = Right$(rdata, Len(rdata) - 10)
    tIndex = UserList(UserIndex).flags.TargetUser
    If UserList(tIndex).flags.Privilegios > 0 And Not UserList(UserIndex).Name = "GALLE" Then
...
If UCase$(Left$(rdata, 13)) = "/ENVENCUESTA " Then
    ...
    Call SendData(ToAll, 0, 0, "||OPCIONES: /VOTSI - /VOTNO | La encuesta durará 30 segundos." & FONTTYPE_FENIX)
    Exit Sub
End If
...
If UCase$(Left$(rdata, 5)) = "/MOD " Then
    ...
    If tIndex <= 0 Then
        ...
        Exit Sub
    End If
    If UserList(tIndex).flags.Privilegios > 1 And UserIndex <> tIndex Then Exit Sub
    ...
    Select Case UCase$(Arg1)
        ...
        Case "MEX"
            ...
            Call CheckUserLevel(tIndex)
            Call SendUserEXP(tIndex)
        Case "ADV" ' SIST de ADVERTENCIAS
            If UserList(UserIndex).flags.Privilegios < 3 Then Exit Sub
            UserList(tIndex).Stats.Advertencias = val(Arg2)
        Case "BODY"
            If UserList(UserIndex).flags.Privilegios < 3 Then Exit Sub
        ...
        Case "HP"
            If UserList(UserIndex).flags.Privilegios < 3 Then Exit Sub
            If val(Arg2) > 10000 Then Exit Sub
...
If UCase$(Left$(rdata, 11)) = "/GANOTORNEO" Then
    ...
    Call LogPuntos(UserList(UserIndex).Name & " dio " & rdata & " Puntos de Torneo " & " a " & UserList(tIndex).Name)
    Exit Sub
End If
...
If UCase$(Left$(rdata, 10)) = "/GANOQUEST" Then
    ...
    Call LogPuntos(UserList(UserIndex).Name & " dio " & rdata & " Puntos de Quest " & " a " & UserList(tIndex).Name)
    Exit Sub
End If
...
If UCase$(Left$(rdata, 13)) = "/PERDIOTORNEO" Then
    ...
    Call LogPuntos(UserList(UserIndex).Name & " saco " & rdata & " Puntos de Torneo " & " a " & UserList(tIndex).Name)
    Exit Sub
End If
...
If UCase$(Left$(rdata, 12)) = "/PERDIOQUEST" Then
    ...
    Call LogPuntos(UserList(UserIndex).Name & " saco " & rdata & " Puntos de Quest " & " a " & UserList(tIndex).Name)
    Exit Sub
End If
...
If UCase$(rdata) = "/APAGAR" Then
    If UserList(UserIndex).Name = "GALLE" Or UserList(UserIndex).Name = "JARRI" Then
