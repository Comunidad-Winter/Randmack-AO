...
UserList(UserIndex).flags.EsConseNeutral = val(GetVar(UserFile, "FLAGS", "EsConseNeutral"))
'CARGAMOS COUNTERS
...
Call WriteVar(UserFile, "FLAGS", "EsConseNeutral", val(UserList(UserIndex).flags.EsConseNeutral))
