...
Not UserList(UserIndex).POS.Map = 207 And _
Not UserList(UserIndex).POS.Map = 208 And _
Not UserList(UserIndex).POS.Map = 209 And _
Not UserList(UserIndex).POS.Map = 210 And _
Not UserList(UserIndex).POS.Map = 211 And _
Not UserList(UserIndex).POS.Map = 212 And _
Not UserList(UserIndex).POS.Map = 190 And _
Not UserList(UserIndex).POS.Map = 191 And _
Not UserList(UserIndex).POS.Map = 1 Then
